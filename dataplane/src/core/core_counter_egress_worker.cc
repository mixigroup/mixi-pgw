...
/*! @addtogroup mixi_pgw_data_plane
    @file       core_counter_egress_worker.cc
    @brief      counter egress worker core implemented
*******************************************************************************
	counter - egress : \n
     \n
*******************************************************************************
...
/**
   counter egress worker core interface  :  constructor \n
   *******************************************************************************
   constructor\n
   *******************************************************************************
 ...
 */
MIXIPGW::CoreCounterEgressWorker::CoreCounterEgressWorker(COREID lcore):CoreCounterWorker(lcore, COUNTER_EGRESS){
}
/**
   counter egress - logger worker core interface  : destructor\n
   *******************************************************************************
   destructor\n
   *******************************************************************************
 */
MIXIPGW::CoreCounterEgressWorker::~CoreCounterEgressWorker(){
}

TYPE MIXIPGW::CoreCounterEgressWorker::GetType(void){
    return(TYPE::COUNTER);
}

/**
   counter egress - logger worker core : virtual cycle : 1 cycle\n
   *******************************************************************************
   \n
   *******************************************************************************
 ...
 */
RETCD MIXIPGW::CoreCounterEgressWorker::Cycle(void* arg, uint64_t* cnt){
    int n = 0;
