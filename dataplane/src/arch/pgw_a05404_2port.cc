...
app->Add(new CorePgwIngressDistributorWorker(5,uri.c_str(),1801,13,PGW_TUNNEL_IP,PGW_TUNNEL_IP,0,0));
app->Add(new CorePgwEgressDistributorWorker(7,uri.c_str(),1805,15,PGW_TUNNEL_IP,PGW_TUNNEL_IP,0,0));
...
app->Add(new CorePgwIngressDistributorWorker(OFFSET(5),uri.c_str(),OFFSET(1801),OFFSET(13),PGW_TUNNEL_IP,PGW_TUNNEL_IP,0,0));
app->Add(new CorePgwEgressDistributorWorker(OFFSET(7),uri.c_str(),OFFSET(1805),OFFSET(15),PGW_TUNNEL_IP,PGW_TUNNEL_IP,0,0));
