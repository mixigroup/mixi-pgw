...
cores.push_back(new CorePgwIngressTunnelWorker(2,uri.c_str(),15832,28,PGW_TUNNEL_IP,PGW_TUNNEL_IP_S,0,0));
cores.push_back(new CoreCounterIngressWorker(3));
cores.push_back(new CoreTx(1, 0, 4));
cores.push_back(new CoreCounterLogWorker(5, uri.c_str(), 60));

AddCores(COREID(8),cores);

cores2.push_back(new CoreRx(1, 0, 6, TUNNEL_EGRESS));
cores2.push_back(new CorePgwEgressTunnelWorker(7,uri.c_str(),15833,30,PGW_TUNNEL_IP,PGW_TUNNEL_IP_S,0,0));
cores2.push_back(new CoreCounterEgressWorker(8));
cores2.push_back(new CoreTx(0, 9));
cores2.push_back(new CoreCounterLogWorker(10, uri.c_str(), 62));

AddCores(COREID(10),cores2);
